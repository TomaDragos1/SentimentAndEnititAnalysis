...
test_data = pd.read_csv("test_dataset.csv", nrows=250)
...
checkpoint1 = ModelCheckpoint("best_model1.hdf5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')


history = model.fit(input_data, labels, epochs=20, validation_data=(test_data, test_labels),
